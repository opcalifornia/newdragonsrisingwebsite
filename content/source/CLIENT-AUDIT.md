...
| Refund Policy page | Same — unfilled Wix template | Complete draft: all sales final (shop, module enrollment, seminars) per the client's direction, with one standard carve-out for defective/incorrect physical items |
